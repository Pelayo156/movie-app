...
function Navbar() {
  ...
  return (
    <nav className="flex px-4 md:px-10 lg:px-20 h-20 justify-between items-center bg-black shadow-2xl fixed top-0 left-0 right-0 z-50">
      ...
      {/* Íconos móvil: user/login + hamburguesa */}
      <div className="md:hidden flex items-center space-x-4">
        {isAuthenticated ? (
          <div className="relative">
            ...
            />
            {isUserOpen && (
              <div className="absolute right-0 z-50 mt-4 w-56 origin-top-right rounded-lg bg-black shadow-xl ring-1 ring-black ring-opacity-5 border border-gray-700">
      ...
      {/* Ícono de usuario/login desktop */}
